...
banner "Mobile Repo PAT Setup"

stage "GitHub — Create Personal Access Token"
say "We need a GitHub Personal Access Token (PAT) so this repository can push schema updates to the mobile repository."
