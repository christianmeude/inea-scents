...
<template>
    ...
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <!-- Modal Panel -->
        <div class="relative bg-white dark:bg-brand-dark-surface rounded-3xl shadow-2xl w-full max-w-3xl mx-4 max-h-[90vh] overflow-y-auto transform transition-all">
            <div class="p-8">
                <!-- Header -->
